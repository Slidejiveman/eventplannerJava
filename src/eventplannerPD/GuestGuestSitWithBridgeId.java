...
public class GuestGuestSitWithBridgeId {	
	private int guestSitWithBridgeId;
    private int guestId;
    private int guestSitWithId;
    
	public int getGuestGuestSitWithBridgeId() {
		return guestSitWithBridgeId;
	}
	public void setGuestGuestSitWithBridgeId(int guestGuestSitWithBridgeId) {
		this.guestSitWithBridgeId = guestGuestSitWithBridgeId;
	}
