...
/**
 * The authorizer is a class used to determine if a login attempt is successful. Only authorized individuals as determined by username and password may use the system.
 */
public class Authorizer {
    ...
    /**
     * The currently logged in user if applicable. The permissions related to the application are determined by which user is the active user.
     */
    ...
    /**
     * This method determines whether the individual who attempted to login is a valid user. If so, the user gains access to the system.
     * @param user The user is passed in to compare whether or not the user's username and password matches what was entered at the keyboard.
